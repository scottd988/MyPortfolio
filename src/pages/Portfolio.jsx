    ...
    const projects = [
        {
          ...
          return (
            ...
            {projects.map((project, i) => (
             <Col key={i}>
             <Card>
               <Card.Img variant="top" src={project.imageFile} alt={project.title + '-screenshot'} />
               <Card.Body>
